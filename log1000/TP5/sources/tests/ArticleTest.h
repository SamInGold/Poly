...
void ArticleTest::testgetters(void)
{
    ...
    string editeurName = art->getEditeur()->getName();
    string editeurCodePostal = art->getEditeur()->getCodePostal();
    string editeurAddress = art->getEditeur()->getAddress();
